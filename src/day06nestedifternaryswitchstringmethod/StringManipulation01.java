...
public class StringManipulation01 {
		/*
		 String Methods:
		 1) toUpperCase()		2)toLowerCase() 	3) charArt()   4) equals()		5) equalsIgnoreCase		6)length()
		 	7)next()		8)nextLine()		9)indexOf()  10)lastIndex()   11)contains()
	...
	public static void main(String[] args) {
		...
		// indexOf() returns the index of first occurense of the character
		...
		// if you use index of with 2 parameters, Java looks for the character after the given index.
		// Second parameter is inclusive
		System.out.println(str.indexOf('i', 8)); //13  (8.harf ve sonraki i'nin indexi ne?)
		...
		String result = s.indexOf(ch)==-1 ? "The String has no the character" : "The String has the character"; // -1 icin 26. satira bak
		System.out.println(result);
		
		
		
		//lastIndexOf() returns the index of last occurense of the character
		...
		//In lastIndexOf() method you can use char and String. Both are acceptable
				...
				/*
				 ...
				 If the character dos not exist or exist just once print "Not good!"
