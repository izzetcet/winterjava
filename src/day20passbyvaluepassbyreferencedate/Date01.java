...
public class Date01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(currentDate1);// bugunun tarihini verir
		...
		System.out.println(currentDate1.plusDays(3).plusMonths(2).plusYears(1));// All change 2022-05-10
		...
		System.out.println(currentDate1.getDayOfYear());// 66 .yilin kacinci gunundeyiz?
		...
		System.out.println(currentDate1.minusYears(1).minusMonths(3).minusYears(5));//2014-12-07
		...
		System.out.println(currentTime1);//20:13:47.567353100
		System.out.println(currentTime1.plusMinutes(11));//20:24:47.567353100
