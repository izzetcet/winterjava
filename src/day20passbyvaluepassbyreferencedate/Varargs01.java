 ...
 *2)Varargs bahves like lists but behind the varargs arrays work
 *3)To declare a varargs use "int... a" or "String... s" etc..
 *4)Varargs must be the last parameter inside the method parenthesis.
 * Yoksa ikinci parameter ulasilamaz olur
 *5) Can I use multiple varargs inside a method parenthesis? NO cunku ikinci parameter ulasilamaz olur
 */
