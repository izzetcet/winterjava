...
public class List03ListMethods2 {
...
//		System.out.println(list2);//[]
		...
		//It reurns true if any element is removed otherwise it returns false
		...
		//As you know, arrays are not flexoble in length, the list which is created from an array will not be 
		//flexible in size.
